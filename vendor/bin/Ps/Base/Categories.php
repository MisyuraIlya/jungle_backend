...
abstract class Categories implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Ps\\Map\\CategoriesTableMap';
    ...
    /**
     * The value for the inner_title field.
     *
     * @var        string|null
     */
    protected $inner_title;
    ...
    /**
     * Initializes internal state of Ps\Base\Categories object.
     */
    ...
    /**
     * Get the [inner_title] column value.
     *
     * @return string|null
     */
    ...
    public function setExId($v)
    {
        ...
        if ($this->ex_id !== $v) {
            $this->ex_id = $v;
            $this->modifiedColumns[CategoriesTableMap::COL_EX_ID] = true;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[CategoriesTableMap::COL_CODE] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[CategoriesTableMap::COL_TITLE] = true;
        }
    ...
    /**
     * Set the value of [inner_title] column.
     *
     * @param string|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setInnerTitle($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->inner_title !== $v) {
            $this->inner_title = $v;
            $this->modifiedColumns[CategoriesTableMap::COL_INNER_TITLE] = true;
        }
    ...
    public function setImg($v)
    {
        ...
        if ($this->img !== $v) {
            $this->img = $v;
            $this->modifiedColumns[CategoriesTableMap::COL_IMG] = true;
        }
    ...
    public function setImgWide($v)
    {
        ...
        if ($this->img_wide !== $v) {
            $this->img_wide = $v;
            $this->modifiedColumns[CategoriesTableMap::COL_IMG_WIDE] = true;
        }
    ...
    public function setOrden($v)
    {
        ...
        if ($this->orden !== $v) {
            $this->orden = $v;
            $this->modifiedColumns[CategoriesTableMap::COL_ORDEN] = true;
        }
    ...
    public function setUnpublished($v)
    {
        ...
        if ($this->unpublished !== $v) {
            $this->unpublished = $v;
            $this->modifiedColumns[CategoriesTableMap::COL_UNPUBLISHED] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CategoriesTableMap::translateFieldName('ParentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->parent_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CategoriesTableMap::translateFieldName('ExId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ex_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CategoriesTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CategoriesTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CategoriesTableMap::translateFieldName('InnerTitle', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inner_title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CategoriesTableMap::translateFieldName('Img', TableMap::TYPE_PHPNAME, $indexType)];
            $this->img = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CategoriesTableMap::translateFieldName('ImgWide', TableMap::TYPE_PHPNAME, $indexType)];
            $this->img_wide = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CategoriesTableMap::translateFieldName('Orden', TableMap::TYPE_PHPNAME, $indexType)];
            $this->orden = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CategoriesTableMap::translateFieldName('Unpublished', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 10; // 10 = CategoriesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Ps\\Categories'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategoriesTableMap::COL_EX_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ex_id';
        }
        if ($this->isColumnModified(CategoriesTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(CategoriesTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'title';
        }
        if ($this->isColumnModified(CategoriesTableMap::COL_INNER_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'inner_title';
        }
        if ($this->isColumnModified(CategoriesTableMap::COL_IMG)) {
            $modifiedColumns[':p' . $index++]  = 'img';
        }
        if ($this->isColumnModified(CategoriesTableMap::COL_IMG_WIDE)) {
            $modifiedColumns[':p' . $index++]  = 'img_wide';
        }
        if ($this->isColumnModified(CategoriesTableMap::COL_ORDEN)) {
            $modifiedColumns[':p' . $index++]  = 'orden';
        }
        if ($this->isColumnModified(CategoriesTableMap::COL_UNPUBLISHED)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'title':
                        ...
                        break;
                    case 'inner_title':
                        $stmt->bindValue($identifier, $this->inner_title, PDO::PARAM_STR);
                        break;
                    case 'img':
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = []): array
    {
        ...
        $result = [
            ...
            $keys[5] => $this->getInnerTitle(),
            $keys[6] => $this->getImg(),
            $keys[7] => $this->getImgWide(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) {
            $this->setInnerTitle($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setImg($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setImgWide($arr[$keys[7]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(CategoriesTableMap::COL_EX_ID)) {
            $criteria->add(CategoriesTableMap::COL_EX_ID, $this->ex_id);
        }
        if ($this->isColumnModified(CategoriesTableMap::COL_CODE)) {
            $criteria->add(CategoriesTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(CategoriesTableMap::COL_TITLE)) {
            $criteria->add(CategoriesTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(CategoriesTableMap::COL_INNER_TITLE)) {
            $criteria->add(CategoriesTableMap::COL_INNER_TITLE, $this->inner_title);
        }
        if ($this->isColumnModified(CategoriesTableMap::COL_IMG)) {
            $criteria->add(CategoriesTableMap::COL_IMG, $this->img);
        }
        if ($this->isColumnModified(CategoriesTableMap::COL_IMG_WIDE)) {
            $criteria->add(CategoriesTableMap::COL_IMG_WIDE, $this->img_wide);
        }
        if ($this->isColumnModified(CategoriesTableMap::COL_ORDEN)) {
            $criteria->add(CategoriesTableMap::COL_ORDEN, $this->orden);
        }
        if ($this->isColumnModified(CategoriesTableMap::COL_UNPUBLISHED)) {
            $criteria->add(CategoriesTableMap::COL_UNPUBLISHED, $this->unpublished);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Ps\Categories (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setInnerTitle($this->getInnerTitle());
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Ps\Categories Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
