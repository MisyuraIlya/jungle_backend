...
abstract class Banners implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Ps\\Map\\BannersTableMap';
    ...
    /**
     * Initializes internal state of Ps\Base\Banners object.
     */
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[BannersTableMap::COL_TYPE] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[BannersTableMap::COL_TITLE] = true;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[BannersTableMap::COL_TEXT] = true;
        }
    ...
    public function setImg($v)
    {
        ...
        if ($this->img !== $v) {
            $this->img = $v;
            $this->modifiedColumns[BannersTableMap::COL_IMG] = true;
        }
    ...
    public function setLink($v)
    {
        ...
        if ($this->link !== $v) {
            $this->link = $v;
            $this->modifiedColumns[BannersTableMap::COL_LINK] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BannersTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BannersTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BannersTableMap::translateFieldName('Text', TableMap::TYPE_PHPNAME, $indexType)];
            $this->text = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : BannersTableMap::translateFieldName('Img', TableMap::TYPE_PHPNAME, $indexType)];
            $this->img = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : BannersTableMap::translateFieldName('Link', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Ps\\Banners'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BannersTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'type';
        }
        if ($this->isColumnModified(BannersTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'title';
        }
        if ($this->isColumnModified(BannersTableMap::COL_TEXT)) {
            $modifiedColumns[':p' . $index++]  = 'text';
        }
        if ($this->isColumnModified(BannersTableMap::COL_IMG)) {
            $modifiedColumns[':p' . $index++]  = 'img';
        }
        if ($this->isColumnModified(BannersTableMap::COL_LINK)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(BannersTableMap::COL_TYPE)) {
            $criteria->add(BannersTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(BannersTableMap::COL_TITLE)) {
            $criteria->add(BannersTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(BannersTableMap::COL_TEXT)) {
            $criteria->add(BannersTableMap::COL_TEXT, $this->text);
        }
        if ($this->isColumnModified(BannersTableMap::COL_IMG)) {
            $criteria->add(BannersTableMap::COL_IMG, $this->img);
        }
        if ($this->isColumnModified(BannersTableMap::COL_LINK)) {
            $criteria->add(BannersTableMap::COL_LINK, $this->link);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Ps\Banners (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Ps\Banners Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
