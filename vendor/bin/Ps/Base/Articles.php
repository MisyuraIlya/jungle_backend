...
abstract class Articles implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Ps\\Map\\ArticlesTableMap';
    ...
    /**
     * Initializes internal state of Ps\Base\Articles object.
     */
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[ArticlesTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[ArticlesTableMap::COL_TEXT] = true;
        }
    ...
    public function setImg($v)
    {
        ...
        if ($this->img !== $v) {
            $this->img = $v;
            $this->modifiedColumns[ArticlesTableMap::COL_IMG] = true;
        }
    ...
    public function setUnpublished($v)
    {
        ...
        if ($this->unpublished !== $v) {
            $this->unpublished = $v;
            $this->modifiedColumns[ArticlesTableMap::COL_UNPUBLISHED] = true;
        }
    ...
    public function setOrden($v)
    {
        ...
        if ($this->orden !== $v) {
            $this->orden = $v;
            $this->modifiedColumns[ArticlesTableMap::COL_ORDEN] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ArticlesTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ArticlesTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ArticlesTableMap::translateFieldName('Text', TableMap::TYPE_PHPNAME, $indexType)];
            $this->text = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ArticlesTableMap::translateFieldName('Img', TableMap::TYPE_PHPNAME, $indexType)];
            $this->img = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ArticlesTableMap::translateFieldName('Unpublished', TableMap::TYPE_PHPNAME, $indexType)];
            $this->unpublished = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ArticlesTableMap::translateFieldName('Orden', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = ArticlesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Ps\\Articles'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ArticlesTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(ArticlesTableMap::COL_TEXT)) {
            $modifiedColumns[':p' . $index++]  = 'text';
        }
        if ($this->isColumnModified(ArticlesTableMap::COL_IMG)) {
            $modifiedColumns[':p' . $index++]  = 'img';
        }
        if ($this->isColumnModified(ArticlesTableMap::COL_UNPUBLISHED)) {
            $modifiedColumns[':p' . $index++]  = 'unpublished';
        }
        if ($this->isColumnModified(ArticlesTableMap::COL_ORDEN)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(ArticlesTableMap::COL_DESCRIPTION)) {
            $criteria->add(ArticlesTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(ArticlesTableMap::COL_TEXT)) {
            $criteria->add(ArticlesTableMap::COL_TEXT, $this->text);
        }
        if ($this->isColumnModified(ArticlesTableMap::COL_IMG)) {
            $criteria->add(ArticlesTableMap::COL_IMG, $this->img);
        }
        if ($this->isColumnModified(ArticlesTableMap::COL_UNPUBLISHED)) {
            $criteria->add(ArticlesTableMap::COL_UNPUBLISHED, $this->unpublished);
        }
        if ($this->isColumnModified(ArticlesTableMap::COL_ORDEN)) {
            $criteria->add(ArticlesTableMap::COL_ORDEN, $this->orden);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Ps\Articles (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Ps\Articles Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
