...
class BannersTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Ps.Map.BannersTableMap';
     ...
     */
    public const OM_CLASS = '\\Ps\\Banners';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Ps.Banners';
     ...
     */
    public const COL_ID = 'banners.id';

    /**
     * the column name for the type field
     */
    public const COL_TYPE = 'banners.type';

    /**
     * the column name for the title field
     */
    public const COL_TITLE = 'banners.title';

    /**
     * the column name for the text field
     */
    public const COL_TEXT = 'banners.text';

    /**
     * the column name for the img field
     */
    public const COL_IMG = 'banners.img';

    /**
     * the column name for the link field
     */
    public const COL_LINK = 'banners.link';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Type', 'Title', 'Text', 'Img', 'Link', ],
        self::TYPE_CAMELNAME     => ['id', 'type', 'title', 'text', 'img', 'link', ],
        self::TYPE_COLNAME       => [BannersTableMap::COL_ID, BannersTableMap::COL_TYPE, BannersTableMap::COL_TITLE, BannersTableMap::COL_TEXT, BannersTableMap::COL_IMG, BannersTableMap::COL_LINK, ],
        self::TYPE_FIELDNAME     => ['id', 'type', 'title', 'text', 'img', 'link', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Type' => 1, 'Title' => 2, 'Text' => 3, 'Img' => 4, 'Link' => 5, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'type' => 1, 'title' => 2, 'text' => 3, 'img' => 4, 'link' => 5, ],
        self::TYPE_COLNAME       => [BannersTableMap::COL_ID => 0, BannersTableMap::COL_TYPE => 1, BannersTableMap::COL_TITLE => 2, BannersTableMap::COL_TEXT => 3, BannersTableMap::COL_IMG => 4, BannersTableMap::COL_LINK => 5, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'type' => 1, 'title' => 2, 'text' => 3, 'img' => 4, 'link' => 5, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'banners.id' => 'ID',
        'BannersTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'Type' => 'TYPE',
        'Banners.Type' => 'TYPE',
        'type' => 'TYPE',
        'banners.type' => 'TYPE',
        'BannersTableMap::COL_TYPE' => 'TYPE',
        'COL_TYPE' => 'TYPE',
        'Title' => 'TITLE',
        'Banners.Title' => 'TITLE',
        'title' => 'TITLE',
        'banners.title' => 'TITLE',
        'BannersTableMap::COL_TITLE' => 'TITLE',
        'COL_TITLE' => 'TITLE',
        'Text' => 'TEXT',
        'Banners.Text' => 'TEXT',
        'text' => 'TEXT',
        'banners.text' => 'TEXT',
        'BannersTableMap::COL_TEXT' => 'TEXT',
        'COL_TEXT' => 'TEXT',
        'Img' => 'IMG',
        'Banners.Img' => 'IMG',
        'img' => 'IMG',
        'banners.img' => 'IMG',
        'BannersTableMap::COL_IMG' => 'IMG',
        'COL_IMG' => 'IMG',
        'Link' => 'LINK',
        'Banners.Link' => 'LINK',
        'link' => 'LINK',
        'banners.link' => 'LINK',
        'BannersTableMap::COL_LINK' => 'LINK',
        'COL_LINK' => 'LINK',
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->addColumn('text', 'Text', 'VARCHAR', false, 1000, null);
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BannersTableMap::COL_TYPE);
            $criteria->addSelectColumn(BannersTableMap::COL_TITLE);
            $criteria->addSelectColumn(BannersTableMap::COL_TEXT);
            $criteria->addSelectColumn(BannersTableMap::COL_IMG);
            $criteria->addSelectColumn(BannersTableMap::COL_LINK);
        } else {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(BannersTableMap::COL_ID);
            $criteria->removeSelectColumn(BannersTableMap::COL_TYPE);
            $criteria->removeSelectColumn(BannersTableMap::COL_TITLE);
            $criteria->removeSelectColumn(BannersTableMap::COL_TEXT);
            $criteria->removeSelectColumn(BannersTableMap::COL_IMG);
            $criteria->removeSelectColumn(BannersTableMap::COL_LINK);
        } else {
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Ps\Banners) { // it's a model object
